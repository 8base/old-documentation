...
* `context.invokeFunction(taskName, args, options)` allows you to invoke other functions. You can read more about it [here](https://docs.8base.com/docs/8base-console/custom-functions).

...
_To test this feature, implement the `hello` resolver from [Resolvers](https://docs.8base.com/docs/8base-console/custom-functions/resolvers) and run the following command in your CLI._

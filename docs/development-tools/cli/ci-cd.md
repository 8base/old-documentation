...
You can read more about System and User Parts of 8base workspace/application in our [Overview](/docs/getting-started) section.
...
### Migration file structure
 ...
 Filename pattern of migration is:
...
You can check migrations to committed with `migration status` and easily just delete  migration file if you don’t need corresponding change in your Schema/Data.
...
It is important to know that *[Custom Logic (Functions)](/docs/8base-console/custom-functions)* are being deployed at the same time with migrations files after ‘migration commit’ execution by default.
...
Backup (snapshot) contains full state of Environment: [System and User Parts](/docs/getting-started/getting-started) at the same time.

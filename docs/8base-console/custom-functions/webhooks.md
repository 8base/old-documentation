...
### Webhook Arguments
To learn about the arguments that are passed to webhooks, review the [custom function arguments docs.](https://docs.8base.com/docs/8base-console/custom-functions/#custom-function-arguments)
...
For systems that require a secure webhook, access tokens from authorized systems get [set as a environment variables](https://docs.8base.com/docs/development-tools/dev-env/runtime-environment/#environment-variables) in the 8base workspace. The authorized system is then able to specify their access token as a custom header, which then get validated within the webhook function.

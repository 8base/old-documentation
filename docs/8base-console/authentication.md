...
![Authentication flow diagram](../images/8base-auth-diagram-1.png)
...
#### getToken Resolver
A custom *getToken* resolver mutation function must be deployed to the workspace. This can be done by installing the [8base CLI](../development-tools/cli).

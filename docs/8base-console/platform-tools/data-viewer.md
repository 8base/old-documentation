...
Please refer to the [CLI's Import](https://docs.8base.com/docs/development-tools/cli/commands#import) command docs to import more complex data (related records, images, smart fields, etc).

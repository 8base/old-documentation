...
You can choose several fields on the table by which the index will be constructed, as well as whether or not it should be a *Unique Index*. When naming the index, insure that no spaces are used.

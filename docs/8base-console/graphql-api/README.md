...
*Note: Using [Custom Functions](https://docs.8base.com/docs/8base-console/custom-functions), these GraphQL resources can be extended and added to in any way seen fit.*

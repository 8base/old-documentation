...
* [GraphQL API](8base-console/graphql-api/README.md)
  * [Queries](8base-console/graphql-api/queries/README.md)
    ...
    * [Aggregation queries](8base-console/graphql-api/queries/aggregation-query.md)
    ...
    * [Pagenated list queries](8base-console/graphql-api/queries/paginated-list-query.md)

<template>
  <Section>
  	<h2 class="text-center mb-x2">Get Connected</h2>
    <div class="grid-cols container container-md grid-cols--2">
      ...
      <Card class="sponsor text-center">
	      ...
	      <p>Find us on <a href="8base-community.slack.com"  rel="noopener" target="_blank">Slack</a> to chat with 8base team members on the developer community.</p>
    	</Card>
    </div>
  </Section>
</template>
